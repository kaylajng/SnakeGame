...
class Snake:
    ...
    Attributes:
        segments(list): A list containing turtle segments representing the snake
        head (Turtle): The head of the snake
    """
    ...
    def hit_wall(self, head, wall_pos):
        for pos in wall_pos:
            if head.distance(pos) < 15:
                return True
        return False
